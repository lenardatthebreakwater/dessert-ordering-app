        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {desserts.map((dessert) => {
                ...
                return (
                  <Card key={dessertId} className="overflow-hidden border-0 shadow-sm">
                      ...
                      <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2">
                        {!isInCart(dessertId) ? (
                          <Button
                            ...
                            className="bg-white text-rose-900 border-2 border-red-500 hover:bg-red-500 hover:text-white rounded-full px-6 py-2 font-semibold shadow-lg"
                          >
                            <Image src="/assets/images/icon-add-to-cart.svg" alt="Add to Cart" width={20} height={20} />
                            <span className="ml-2">Add to Cart</span>
                          </Button>
                        ) : (
                          <div className="bg-red-500 text-white rounded-full px-4 py-2 flex items-center gap-3 shadow-lg">
                            <Button
                              size="sm"
                              variant="ghost"
                              className="h-6 w-6 p-0 rounded-full border border-white hover:bg-white hover:text-red-500"
                              onClick={() => updateQuantity(dessertId, -1)}
                            >
                              <Image src="/assets/images/icon-decrement-quantity.svg" alt="Decrease" width={12} height={12} />
                            </Button>
                            <span className="font-semibold min-w-[20px] text-center">{getItemQuantity(dessertId)}</span>
                            <Button
                              size="sm"
                              variant="ghost"
                              className="h-6 w-6 p-0 rounded-full border border-white hover:bg-white hover:text-red-500"
                    ...
                    <CardContent className="pt-8 pb-4">
                      ...
                      <h3 className="font-semibold text-rose-900 mb-2">{dessert.name}</h3>
                      <p className="text-red-500 font-semibold">${dessert.price.toFixed(2)}</p>
                    </CardContent>
                  </Card>
                )
              })}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg p-6 sticky top-8">
              <h2 className="text-2xl font-bold text-red-500 mb-6">Your Cart ({getTotalItems()})</h2>

              {cart.length === 0 ? (
                <div className="text-center py-8">
                  <div className="w-32 h-32 mx-auto mb-4 bg-rose-100 rounded-full flex items-center justify-center">
                ...
                <>
                    ...
                    {cart.map((item) => (
                      <div key={item.id} className="flex items-center justify-between py-2">
                        ...
                        <Button
                          size="sm"
                          variant="ghost"
                          className="h-6 w-6 p-0 rounded-full border border-rose-300 hover:bg-rose-100"
                  ...
                  <div className="flex items-center gap-2 mb-6 text-sm text-rose-600">
                    <Image src="/assets/images/icon-carbon-neutral.svg" alt="Carbon Neutral" width={18} height={18} />
                    <span>
                  ...
                  <Button
                    ...
                    className="w-full bg-red-500 hover:bg-red-600 text-white py-3 rounded-full font-semibold"
                  >
                    Confirm Order
                  </Button>
                </>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="text-center py-6">
            ...
            <div className="space-y-4 mb-8">
              {cart.map((item) => (
                <div key={item.id} className="flex items-center gap-4 p-3 bg-rose-50 rounded-lg">
                  <Image
